...
PARAM$experimento <- "HT824_EC03_semillero" #Random seeds
...
# Parámetros fijos
PARAM$finalmodel$num_iterations <- 189
PARAM$finalmodel$learning_rate <- 0.102942166463472
PARAM$finalmodel$feature_fraction <- 0.553883377149905
PARAM$finalmodel$min_data_in_leaf <- 4178
PARAM$finalmodel$num_leaves <- 719
