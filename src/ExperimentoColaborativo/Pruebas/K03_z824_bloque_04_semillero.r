...
PARAM$experimento <- "HT824_EC04_semillero" #Random seeds
...
# Parámetros fijos
PARAM$finalmodel$num_iterations <- 995
PARAM$finalmodel$learning_rate <- 0.0629286118119246
PARAM$finalmodel$feature_fraction <- 0.611662451627226
PARAM$finalmodel$min_data_in_leaf <- 28918
PARAM$finalmodel$num_leaves <- 545
