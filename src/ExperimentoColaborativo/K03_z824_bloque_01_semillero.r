...
PARAM$experimento <- "HT824_EC01_semillero" #Random seeds
...
# Parámetros fijos
PARAM$finalmodel$num_iterations <- 2151
PARAM$finalmodel$learning_rate <- 0.0484246884493486
PARAM$finalmodel$feature_fraction <- 0.450948096619835
PARAM$finalmodel$min_data_in_leaf <- 49887
